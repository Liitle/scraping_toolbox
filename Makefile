...
VENV_DIR := $(VENVS_DIR)/scraping_toolbox

# Do not remove this block. It is used by the 'help' rule when
# constructing the help output.
# help:
# help: scraping-toolbox Makefile help
# help:
...
check-coverage:
	...
	@coverage html -d docs/source/coverage --include="src/scraping_toolbox/*"
...
.PHONY: check-types
check-types:
	@MYPYPATH=$(VENV_DIR)/lib/python*/site-packages mypy -p scraping_toolbox --ignore-missing-imports


# help: docs                           - generate project documentation
.PHONY: check-coverage
docs: check-coverage
	@cd docs; rm -rf source/api/scraping_toolbox*.rst source/api/modules.rst build/*
	@cd docs; make html
...
.PHONY: dist-test
dist-test: dist
	@cd dist && ../tests/test-dist.bash ./scraping_toolbox-*-py3-none-any.whl


# help: dist-upload                    - upload a wheel distribution package
.PHONY: dist-upload
dist-upload:
	@twine upload dist/scraping_toolbox-*-py3-none-any.whl
